  ...
  watch: {
    show: async function () {
      if (this.show) {
        ...
        this.medicalRecord.patientId = patientInfo.patientId;
        this.medicalRecord.treatmentTime = this.toYYYYMMDD(new Date());
